...
This is the readme for test, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Test) > Ok.
...
- To run the project find Test.java (which will be in under src/main/java/test) and right click > Run 'Test'
